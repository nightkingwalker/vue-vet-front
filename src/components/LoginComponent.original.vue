    ...
    <div class="p-8 bg-white dark:bg-stone-900 shadow-lg rounded-lg max-w-md w-full">
      ...
      <form v-if="!requires2FA" @submit.prevent="login">
        ...
        <div class="flex items-end justify-end">
          <button
            type="submit"
            class="p-button p-button-content !bg-[var(--p-primary-contrast-color)] !text-[var(--p-primary-color)] py-2 px-4 rounded focus:outline-none focus:shadow-outline h-8"
