    ...
    <Card v-if="medicalRecord.medical_examinations.length > 0">
      <template #title>
        <div class="flex justify-between">
          ...
          }" rounded size="small" class="!text-xs !text-primary mx-2" @click="
            isEditable = !isEditable;
          // console.log(medicalRecord.medical_examinations);
          " />
        </div>
      </template>
      <template #content>
                ...
                <StepPanel value="3" v-slot="{ activateCallback }">
                  <fieldset class="p-4 border rounded-lg">
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-3">
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <InputNumber fluid v-model="exam.respiratory_rate" showButtons
                            :suffix="exam.respiratory_rate === null ? '' : ' breaths/min'" :min="0" :max="100"
                            :disabled="!isEditable" :value="exam.respiratory_rate === null ? 0 : exam.respiratory_rate
                              " />
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <Select v-model="exam.breathing_pattern" :options="breathingPatterns" optionLabel="label"
                            optionValue="value" class="w-full" :disabled="!isEditable" />
                          <label>{{
                      ...
                      <div class="field mt-3 w-full col-span-2">
                        <div class="flex items-center gap-3">
                          <label class="font-medium">
                            {{
                            $t(
                            "medical_examination_form.fields.abnormal_breathing_pattern"
                            )
                            }}:
                          </label>
                          <ToggleSwitch v-model="exam.abnormal_breathing_pattern" :true-value="'abnormal'"
                            :false-value="'normal'" :disabled="!isEditable" />
                          <span class="text-sm">
                            {{
                            exam.abnormal_breathing_pattern === "abnormal"
                            ? $t("medical_examination_form.options.abnormal")
                            : $t("medical_examination_form.options.normal")
                            }}
                          </span>
                        </div>
                      </div>
                      ...
                      <div v-if="exam.abnormal_breathing_pattern === 'abnormal'"
                        class="col-span-2 grid grid-cols-3 gap-4 bg-gray-100 dark:bg-[var(--p-surface-600)] dark:!text-white rounded-xl py-6 px-4 mt-3">
                        <!-- Type Select -->
                        <div class="field mt-3">
                          <FloatLabel>
                            <Select v-model="exam.abnormal_breathing_type" :options="breathingTypes" optionLabel="label"
                              optionValue="value" :disabled="!isEditable" class="w-full" />
                            <label>{{
                              $t(
                              "medical_examination_form.fields.abnormal_breathing_type"
                              )
                              }}</label>
                          </FloatLabel>
                        </div>
                        ...
                        <div class="field mt-3">
                          <FloatLabel>
                            <Select v-model="exam.abnormal_breathing_severity" :options="breathingSeverities"
                              optionLabel="label" optionValue="value" :disabled="!isEditable" class="w-full" />
                            <label>{{
                              $t(
                              "medical_examination_form.fields.abnormal_breathing_severity"
                              )
                              }}</label>
                          </FloatLabel>
                        </div>
                        ...
                        <div class="field mt-3">
                          <FloatLabel>
                            <Select v-model="exam.abnormal_breathing_location" :options="breathingLocations"
                              optionLabel="label" optionValue="value" :disabled="!isEditable" class="w-full" />
                            <label>{{
                              $t(
                              "medical_examination_form.fields.abnormal_breathing_location"
                              )
                              }}</label>
                          </FloatLabel>
                        </div>
                        ...
                        <!-- Breathing Notes -->
                        <div class="field mt-3 col-span-3">
                          <FloatLabel>
                            <Textarea fluid id="breathing_notes" rows="2" autoResize v-model="exam.breathing_notes"
                              :disabled="!isEditable" class="w-full" />
                ...
                <StepPanel value="6" v-slot="{ activateCallback }">
                  <fieldset class="p-4 border rounded-lg">
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-3">
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <Select v-model="exam.urinary_bladder_filling" fluid :options="[{ label: t('medical_examination_form.options.full'), value: 'full' },
                          { label: t('medical_examination_form.options.empty'), value: 'empty' }]" optionLabel="label"
                            optionValue="value" :disabled="!isEditable" />
                          <label>{{ $t("medical_examination_form.fields.urinary_bladder_filling") }}</label>
                        </FloatLabel>
                      </div>
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <Select v-model="exam.urinary_bladder_pain" fluid :options="[{ label: t('medical_examination_form.options.painful'), value: 'painful' },
                          { label: t('medical_examination_form.options.not_painful'), value: 'not_painful' }]"
                            optionLabel="label" optionValue="value" :disabled="!isEditable" />
                          <label>{{ $t("medical_examination_form.fields.urinary_bladder_pain") }}</label>
                        </FloatLabel>
                      </div>
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <Textarea fluid id="urinary_bladder_contents" rows="2" autoResize
                            v-model="exam.urinary_bladder_contents" :disabled="!isEditable" />
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <InputNumber fluid v-model="exam.urinary_bladder_wall_thickness" mode="decimal" suffix=" mm"
                            :minFractionDigits="1" :disabled="!isEditable" />
                          <label>{{ $t("medical_examination_form.fields.urinary_bladder_wall_thickness") }}</label>
                        </FloatLabel>
                      </div>
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <InputNumber fluid v-model="exam.urinary_bladder_diameter" mode="decimal" suffix=" mm"
                            :minFractionDigits="1" :disabled="!isEditable" />
                          <label>{{ $t("medical_examination_form.fields.urinary_bladder_diameter") }}</label>
                        </FloatLabel>
                      </div>
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <InputNumber fluid v-model="exam.prostate_diameter" mode="decimal" suffix=" mm"
                            :minFractionDigits="1" :disabled="!isEditable" />
                          <label>{{ $t("medical_examination_form.fields.prostate_diameter") }}</label>
                        </FloatLabel>
                      </div>
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <Textarea fluid id="kidneys_exam" rows="2" autoResize v-model="exam.kidneys_exam"
                            :disabled="!isEditable" />
                          <label for="kidneys_exam">{{ $t("medical_examination_form.fields.kidneys_exam") }}</label>
                        </FloatLabel>
                      </div>
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <InputNumber fluid v-model="exam.kidney_dimensions_right" suffix=" mm"
                            :disabled="!isEditable" />
                          <label>{{ $t("medical_examination_form.fields.kidney_dimensions_right") }}</label>
                        </FloatLabel>
                      </div>
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <InputNumber fluid v-model="exam.kidney_dimensions_left" suffix=" mm"
                            :disabled="!isEditable" />
                          <label>{{ $t("medical_examination_form.fields.kidney_dimensions_left") }}</label>
                        </FloatLabel>
                      </div>
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <Textarea fluid id="urethra_external_genitalia" rows="2" autoResize
                            v-model="exam.urethra_external_genitalia" :disabled="!isEditable" />
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <Select v-model="exam.urine_retention" fluid :options="[{ label: t('medical_examination_form.options.complete'), value: 'complete' },
                          ...
                          { label: t('medical_examination_form.options.difficulty'), value: 'difficulty' }]"
                            optionLabel="label" optionValue="value" :disabled="!isEditable" />
                          <label>{{ $t("medical_examination_form.fields.urine_retention") }}</label>
                        </FloatLabel>
                      </div>
                    </div>
