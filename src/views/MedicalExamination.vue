                    ...
                    <div class="grid grid-cols-2 gap-2 mt-3">
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <InputNumber
                            ...
                            v-model="exam.respiratory_rate"
                            showButtons
                            :suffix="exam.respiratory_rate === null ? '' : ' breaths/min'"
                            :min="0"
                            :max="100"
                            :disabled="!isEditable"
                            :value="
                              exam.respiratory_rate === null ? 0 : exam.respiratory_rate
                            "
                          />
                          <label for="respiratory_rate">{{
                            $t("medical_examination_form.fields.respiratory_rate")
                      ...
                      <div class="field mt-3 w-full col-span-2">
                        <div class="flex items-center gap-3">
                          ...
                          <ToggleSwitch
                            v-model="exam.abnormal_breathing_pattern"
                            :true-value="'abnormal'"
                            :false-value="'normal'"
                            :disabled="!isEditable"
                          />
                      ...
                      <div
                        v-if="exam.abnormal_breathing_pattern === 'abnormal'"
                      ...
                      >
                        ...
                        <div class="field mt-3">
                          <FloatLabel>
                            <Select
                              v-model="exam.abnormal_breathing_type"
                        ...
                        <div class="field mt-3">
                          <FloatLabel>
                            <Select
                              v-model="exam.abnormal_breathing_severity"
                        ...
                        <div class="field mt-3">
                          <FloatLabel>
                            <Select
                              v-model="exam.abnormal_breathing_location"
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <Textarea
                            ...
                            rows="2"
                            autoResize
                            v-model="exam.skin_lumps_or_infections"
                            :disabled="!isEditable"
                          />
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <Textarea
                            ...
                            rows="2"
                            autoResize
                            v-model="exam.skin_coat_condition"
                            :disabled="!isEditable"
                          />
                      ...
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <Textarea
                            ...
                            rows="2"
                            autoResize
                            v-model="exam.abdominal_palpation"
                            :disabled="!isEditable"
                          />
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-3">
                      <div class="field mt-3 w-2/3">
                        <FloatLabel>
                          <InputNumber
                            fluid
                            v-model="exam.body_condition_score"
                            showButtons
                            :min="1"
                            :max="10"
                            :disabled="!isEditable"
                    ...
                    <div class="field mt-3 w-2/3">
                      <FloatLabel>
                        <Textarea
                          ...
                          rows="2"
                          autoResize
                          v-model="exam.preliminary_diagnosis"
                          :disabled="!isEditable"
                        />
