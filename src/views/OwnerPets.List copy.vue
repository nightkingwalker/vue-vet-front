 ...
 -->
    <template #grid="slotProps" v-else>
      ...
      >
        ...
        >
          <div
            class="h-full p-4 border border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-600 rounded-xl shadow-sm hover:shadow-md flex flex-col"
            :class="{
              'border-blue-200 dark:border-blue-800': pet.gender === 'Male',
              'border-pink-200 dark:border-pink-800': pet.gender === 'Female',
              'hover:border-blue-300 dark:hover:border-blue-600': pet.gender === 'Male',
              'hover:border-pink-300 dark:hover:border-pink-600': pet.gender === 'Female',
            }"
          >
            <!-- Pet Header -->
            <div
              class="flex items-center gap-3 pb-3 border-b border-surface-100 dark:border-surface-700"
            >
              <div
                class="w-10 h-10 rounded-lg flex items-center justify-center text-white"
                :class="pet.gender === 'Male' ? 'bg-blue-500' : 'bg-pink-500'"
              >
                <i :class="getIconClass(pet.species) + ' text-lg'"></i>
              </div>
            ...
            <div class="mt-3 space-y-2 flex-grow">
              <div class="flex items-start">
                <span class="text-xs text-gray-500 dark:text-gray-400 w-20 flex-shrink-0">
                  {{ $t("owner_pet_list.fields.species") }}
                </span>
            ...
            <!-- Action Button -->
            <div class="mt-4 pt-3 border-t border-surface-100 dark:border-surface-700">
              <RouterLink
                class="w-full p-button !bg-[var(--p-primary-color)] !text-[var(--p-primary-contrast-color)] p-component p-button-sm !text-xs !justify-center"
                :to="{ name: 'PetDetails', params: { petmicrochip: pet.microchip_num } }"
