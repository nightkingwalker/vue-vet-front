<template>
  <DataView
    :value="owners"
    :layout="layout"
    class="!rounded-xl !overflow-y-auto h-[calc(100vh-70px)] drop-shadow-md"
  >
    <template #header>
      <div class="flex justify-between items-center">
        ...
        <InputGroup
          class="!text-gray-800 flex rounded-md overflow-hidden border !border-gray-400 !w-1/5"
        >
          <InputGroupAddon
          ...
          <InputText
            ...
            type="text"
            class="lg:!text-[14px] text-sm !text-gray-800 focus:!ring-0 focus:!ring-offset-0 focus:!border-gray-400 border-0"
          ...
          <Button
            ...
            @click="clearFilters"
          />
          <Button icon="p-button-icon pi pi-trash" v-else @click="clearFilters" />
        </InputGroup>
      </div>
    </template>
            ...
            >
              ...
              <div class="flex flex-col md:items-start gap-2 w-1/3">
                <span class="lg:!text-[14px] text-sm">
                  <i class="pi pi-phone ltr:mr-2 rtl:ml-2 mt-2"></i>
                  <a
                ...
                <span class="lg:!text-[14px] text-sm">
                  <i class="pi pi-map-marker ltr:mr-2 rtl:ml-2"></i>
                  {{ owner.address }}
                </span>
              </div>
              <div class="flex gap-1">
                ...
                <router-link
                  :to="`/` + owner.id + `/pets`"
                  class="p-button-rounded p-button-text p-button-sm flex justify-center items-center p-0"
                  v-tooltip.top="{
    ...
    <template #grid="slotProps" v-else>
      <div class="grid xl:grid-cols-12 grid-cols-10 p-4">
        ...
        >
          ...
          >
            <div class="">
              <div class="owner-name flex flex-col gap2">
                <span class="label">{{ $t("owners.columns.name") }}:</span>
                <span class="value">{{ owner.name }}</span>
              </div>

              <div class="mt-4 text-sm">
                <div class="lg:!text-[14px]">
                  <i class="pi pi-envelope ltr:mr-2 rtl:ml-2 mt-2"></i>
                  <span v-if="owner.showDetails">{{ owner.email }}</span>
                ...
                <div class="whitespace-normal lg:!text-[14px]">
                  <i class="pi pi-map-marker ltr:mr-2 rtl:ml-2 mt-2"></i>
                  {{ owner.address }}
                </div>
              </div>
              <div class="flex flex-col gap-6 mt-6">
                <div class="flex gap-1 justify-between">
                  <Button
                    type="button"
                    icon="p-button-icon pi pi-pencil 2xl:!text-sm lg:!text-xs"
                    label=""
                    v-tooltip.top="{
                      value: $t('owners.actions.edit'),
                      pt: {
                  ...
                  <router-link
                    :to="`/` + owner.id + `/pets`"
                    class="p-button-rounded p-button-text p-button p-component 2xl:!text-sm lg:!text-xs button-transition flex items-center"
                    v-tooltip.top="{
                      value: $t('owners.actions.pets'),
                      pt: {
                        arrow: {
                  ...
                  <Button
                    type="button"
                    icon="p-button-icon pi pi-whatsapp !text-sm"
                    label=""
